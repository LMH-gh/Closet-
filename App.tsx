...
import { GENDER_KEYS, OCCASION_KEYS, STYLE_KEYS } from './constants';
...
const App: React.FC = () => {
  ...
  }, [style, occasion, gender, keyGarment, colorPalette, locale, t]);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 bg-white/60 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-slate-200">
            ...
            <div className="space-y-6">
              ...
              <div>
                <label htmlFor="keyGarment" className="block text-sm font-semibold text-slate-600 mb-2">
                  {t('controls.keyGarment')}
                </label>
                <input
                  type="text"
                  id="keyGarment"
          ...
          <div className="lg:col-span-2">
            <div className="bg-white/60 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-slate-200 min-h-[600px] flex flex-col justify-center items-center">
