export const ja = {
  ...
  controls: {
    ...
    keyAccessory: "キーとなるアクセサリー",
    keyAccessoryPlaceholder: "例：ゴールドのネックレス",
    colors: "希望の色（任意）",
  ...
  garments: {
    None: "なし",
    LittleBlackDress: "リトルブラックドレス",
    Sundress: "サンドレス",
    Blouse: "ブラウス",
    Skirt: "スカート",
    CropTop: "クロップトップ",
    HighWaistedJeans: "ハイウエストジーンズ",
    Blazer: "ブレザー",
    TrenchCoat: "トレンチコート",
    ButtonUpShirt: "ボタンアップシャツ",
    PoloShirt: "ポロシャツ",
    Sweater: "セーター",
    Chinos: "チノパン",
    DenimJeans: "デニムジーンズ",
    BomberJacket: "ボンバージャケット",
    WhiteTShirt: "白いTシャツ",
    Hoodie: "パーカー",
